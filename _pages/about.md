...
<div style="font-family: 'Times New Roman', 'SimSun', serif;">
  <p style="font-size: 20px; line-height: 1.8; text-indent: 2em; text-align: justify; margin-bottom: 1.5em;">
    Our mission is to integrate advanced concepts from robotics, artificial intelligence (AI), machine vision, remote sensing, data mining, and information technology into smart agriculture, focusing on precision orchard management, crop phenotyping, and autonomous production to enhance yield and sustainability. Our core technologies encompass 2D/3D image processing, multispectral/hyperspectral imaging, spectroscopy, deep learning, machine learning, digital mapping, and biochemical sensing—optimized for the dynamic conditions of agricultural fields. The research tools at our disposal include unmanned aerial vehicles (UAVs), unmanned ground vehicles (UGVs), high-resolution video/multispectral/hyperspectral cameras, DGPS for centimeter-level accuracy, and sensors for monitoring soil, plant, and environmental parameters. Our work aims to translate innovative technologies into practical solutions for data-driven and fully autonomous smart farming.
  </p>
</div>
