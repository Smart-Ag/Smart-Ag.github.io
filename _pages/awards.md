...
<div class="filter-buttons mb-4">
  <div class="d-flex flex-wrap justify-content-center gap-3">
    <button class="filter-btn active" data-filter="faculty">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function updateFacultyPagination() {
    ...
    if (startPage > 1) {
      paginationHTML += `
        <li class="page-item">
          <a class="page-link faculty-page" data-page="1">1</a>
        </li>
    ...
    if (endPage < totalFacultyPages) {
      paginationHTML += `
        ${endPage < totalFacultyPages - 1 ? '<li class="page-item disabled"><span class="page-link">...</span></li>' : ''}
        <li class="page-item">
          <a class="page-link faculty-page" data-page="${totalFacultyPages}">${totalFacultyPages}</a>
        </li>
      `;
    }
  ...
  function updateStudentPagination() {
    ...
    if (startPage > 1) {
      paginationHTML += `
        <li class="page-item">
          <a class="page-link student-page" data-page="1">1</a>
        </li>
        ${startPage > 2 ? '<li class="page-item disabled"><span class="page-link">...</span></li>' : ''}
      `;
    }
    ...
    if (endPage < totalStudentPages) {
      paginationHTML += `
        ${endPage < totalStudentPages - 1 ? '<li class="page-item disabled"><span class="page-link">...</span></li>' : ''}
        <li class="page-item">
          <a class="page-link student-page" data-page="${totalStudentPages}">${totalStudentPages}</a>
        </li>
      `;
    }
